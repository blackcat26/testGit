...
<?php } ?>
 ...
 $qid++; ?>
							...
							<div class="form-group questpanel panel_<?php echo $questype['questid']; ?>">
								...
								<div class="col-sm-9">
									<textarea class="form-control" rows="7" cols="4" name="args[examsetting][examscale][<?php echo $questype['questid']; ?>]"><?php echo $this->tpl_var['exam']['examsetting']['examscale'][$questype['questid']]; ?></textarea>
								</div>
							</div>
							<?php } ?>
							<?php } else { ?>
