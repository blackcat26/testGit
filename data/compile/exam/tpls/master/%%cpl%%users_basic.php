...
<?php } ?>
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							...
							<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-users">开通测评</a></li>
							<li class="active">测评选择</li>
						</ol>
					</div>
				</div>
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						课程选择
						<a class="btn btn-primary pull-right" href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-users">开通测评</a>
					</h4>
 ...
 $bid++; ?>
					        <tr>
								...
								<td>
									<?php if($this->tpl_var['openbasics'][$basic['basicid']]){ ?><a class="ajax btn" title="关闭测评" href="index.php?exam-master-users-closebasics&userid=<?php echo $this->tpl_var['userid']; ?>&basicid=<?php echo $basic['basicid']; ?>"><em class="glyphicon glyphicon-minus-sign"></em></a><?php } else { ?><a class="ajax btn" href="index.php?exam-master-users-openbasics&userid=<?php echo $this->tpl_var['userid']; ?>&basicid=<?php echo $basic['basicid']; ?>" title="开启测评"><em class="glyphicon glyphicon-plus-sign"></em></a><?php } ?>
								</td>
					        </tr>
					        <?php } ?>
			        	</tbody>
