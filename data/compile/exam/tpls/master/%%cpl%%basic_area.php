...
<?php } ?>
 ...
 $aid++; ?>
							<tr>
								...
								<td>
									<div class="btn-group">
			                    		<a class="btn" href="index.php?exam-master-basic&search[basicareaid]=<?php echo $area['areaid']; ?>&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>" title="测评"><em class="glyphicon glyphicon-th-list"></em></a>
