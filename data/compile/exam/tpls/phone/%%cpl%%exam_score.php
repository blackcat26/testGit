...
<?php } ?>
		<header class="container-fluid" style="border-bottom:1px solid #ccc;">
            ...
            <!--
			<a id="goEhFun" data-target="views" data-page="views" href="index.php?exam-phone-history-view&ehid=<?php echo $this->tpl_var['ehid']; ?>" class="ajax"></a>
			-->
		</header>
                    ...
                    <div class="row" style="margin-bottom:10px;">
                        ...
                        <div class="col-xs-4" style="margin:10px 0;padding-top:10px;padding-bottom:0px;height:90px;line-height:100px;border-left:1px solid #ccc;">
                            ...
                            <p class="list-group-item-text text-center" style="border:1px solid #f60;font-size:18px;font-weight:bold;height:50px;line-height:50px;width:50px;">
                                <?php echo $this->tpl_var['allright']/$this->tpl_var['allnumber']*100; ?>%
                            </p>
                        </div>
                ...
                <div class="col-xs-12" style="background-color:#fff;margin-top:10px;">
                    <div class="row" style="margin-bottom:10px;">
                        ...
                        <div class="col-xs-4" style="margin:10px 0;padding-top:10px;padding-bottom:0px;height:90px;line-height:100px;border-left:1px solid #ccc;">
                            ...
                            <p class="list-group-item-text text-center" style="border:1px solid #f60;font-size:18px;font-weight:bold;height:50px;line-height:50px;width:50px;">
                                <?php if($this->tpl_var['sessionvars']['examsessiontime'] >= 60){ ?><?php if($this->tpl_var['sessionvars']['examsessiontime']%60){ ?><?php echo intval($this->tpl_var['sessionvars']['examsessiontime']/60)+1; ?><?php } else { ?><?php echo intval($this->tpl_var['sessionvars']['examsessiontime']/60); ?><?php } ?>分钟<?php } else { ?><?php echo $this->tpl_var['sessionvars']['examsessiontime']; ?>秒<?php } ?>
                            </p>
                        </div>
                        <div class="col-xs-5" style="padding:12px 0 0;">
                            <ul class="list-group" style="margin-bottom:10px;">
