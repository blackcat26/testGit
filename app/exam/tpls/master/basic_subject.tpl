							...
							<tr>
								...
								<td>
									<div class="btn-group">
										...
										<a class="btn" href="index.php?exam-master-basic-section&subjectid={x2;v:subject['subjectid']}&page=1&basicid={x2;v:basic['basicid']}{x2;$u}" title="知识点列表"><em class="glyphicon glyphicon-th-list"></em></a>
