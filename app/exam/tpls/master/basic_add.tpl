				...
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							...
							<li><a href="index.php?{x2;$_app}-master-basic">测评管理</a></li>
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					...
					<form action="index.php?exam-master-basic-add" method="post" class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input class="form-control" id="basic" name="args[basic]" type="text" value="{x2;$basic['basic']}" needle="needle" msg="您必须输入测评名称" />
							</div>
						</div>
						<div class="form-group">
