...
<?php } ?>
 ...
 $qid++; ?>
							        <tr>
										<td><input <?php if($question['qruserid'] != $this->tpl_var['_user']['userid']){ ?>disabled<?php } ?>  type="checkbox" name="delids[<?php echo $question['qrid']; ?>]" value="1"></td>
										<td>
										...
										<td>
											<div class="btn-group">
												...
												<!--判断是否是同一个用户-->
												<?php if($question['qruserid'] == $this->tpl_var['_user']['userid']){ ?>
