...
<?php } ?>
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							...
							<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-basic&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>">测评管理</a></li>
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
			        ...
			        <form action="?exam-master-basic-setexamrange" method="post" class="form-horizontal">
						...
						<div class="form-group">
							<label class="control-label col-sm-2">知识点选择：<input type="checkbox" onClick="javascript:$('.section:checkbox').prop('checked',$(this).is(':checked'));"> </label>
						</div>
						<?php $sid = 0;
 ...
 $kid++; ?>
						...
						<?php } ?>
						<div class="form-group">
							<label for="basicexam_auto" class="control-label col-sm-2">测评模式：</label>
							<div class="col-sm-9">
