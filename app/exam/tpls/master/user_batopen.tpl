						...
						<div class="tab-content">
							<div id="panel-65699" class="tab-pane active">
								<form action="index.php?exam-master-users-batopen" method="post" class="form-horizontal">
									...
									<div class="form-group">
										<label class="control-label col-sm-2">测评ID：</label>
									  	<div class="col-sm-9">
										  	<textarea class="form-control" rows="4" needle="needle" msg="您最少需要填写一个测评" name="basics"></textarea>
									  		<span class="help-block">每个测评ID请使用英文逗号隔开</span>
										</div>
									</div>
									<div class="form-group">
