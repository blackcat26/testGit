...
{x2;endif}
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							...
							<li><a href="index.php?{x2;$_app}-master-users">开通测评</a></li>
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						课程选择
						<a class="btn btn-primary pull-right" href="index.php?{x2;$_app}-master-users">开通测评</a>
					</h4>
			        ...
			        <table class="table table-hover table-bordered">
			            ...
			            <tbody>
					        ...
					        <tr>
								...
								<td>
									{x2;if:$openbasics[v:basic['basicid']]}<a class="ajax btn" title="关闭测评" href="index.php?exam-master-users-closebasics&userid={x2;$userid}&basicid={x2;v:basic['basicid']}"><em class="glyphicon glyphicon-minus-sign"></em></a>{x2;else}<a class="ajax btn" href="index.php?exam-master-users-openbasics&userid={x2;$userid}&basicid={x2;v:basic['basicid']}" title="开启测评"><em class="glyphicon glyphicon-plus-sign"></em></a>{x2;endif}
								</td>
					        </tr>
					        {x2;endtree}
			        	</tbody>
