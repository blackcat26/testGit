 ...
 $qid++; ?>
		                        <li style="border-bottom:1px dotted #CCCCCC;padding:0.5rem;">
		                        	<?php echo $quest['questype']; ?>（共<?php echo $this->tpl_var['numbers'][$quest['questid']]; ?>题），选 <input id="question_<?php echo $quest; ?>" type="text" style="width:6rem;height:34px;padding: 1.2rem;background-color: #fff;border: 1px solid #ccc;border-radius: 4px;" name="args[number][<?php echo $quest; ?>]" rel="<?php echo $this->tpl_var['numbers'][$quest]; ?>"/> 题
		                        </li>
		                    	<?php } ?>
		                    </ol>
	                    </div>
