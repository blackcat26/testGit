...
<?php } ?>
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							...
							<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-basic">测评管理</a></li>
							<li class="active">添加测评</li>
						</ol>
					</div>
				</div>
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						添加测评
						<a class="btn btn-primary pull-right" href="index.php?exam-master-basic">测评管理</a>
					</h4>
					<form action="index.php?exam-master-basic-add" method="post" class="form-horizontal">
						<fieldset>
						<div class="form-group">
							<label for="basic" class="control-label col-sm-2">测评名称</label>
							<div class="col-sm-6">
								<input class="form-control" id="basic" name="args[basic]" type="text" value="<?php echo $this->tpl_var['basic']['basic']; ?>" needle="needle" msg="您必须输入测评名称" />
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-2">测评状态</label>
							<div class="col-sm-9">
						...
						<div class="form-group">
							<label for="basicthumb" class="control-label col-sm-2">测评缩略图</label>
							<div class="col-sm-9">
						...
						<div class="form-group">
							<label for="basicsubjectid" class="control-label col-sm-2">测评科目</label>
							<div class="col-sm-4">
								<select class="form-control" id="basicsubjectid" name="args[basicsubjectid]" needle="needle" msg="您必须选择测评科目">
 ...
 $sid++; ?>
						...
						<div class="form-group">
							<label for="basicareaid" class="control-label col-sm-2">测评地区</label>
							<div class="col-sm-4">
								<select class="form-control" id="basicareaid" name="args[basicareaid]" needle="needle" msg="您必须选择测评地区">
 ...
 $aid++; ?>
						...
						<div class="form-group">
							<label class="control-label col-sm-2">做为免费测评</label>
							<div class="col-sm-9">
								<label class="radio-inline">
								...
								<span class="help-block">免费测评用户开通测评时不扣除积分</span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea class="form-control" rows="4" name="args[basicprice]" id="basicprice"><?php echo $this->tpl_var['basic']['basicprice']; ?></textarea>
							  	<span class="help-block">请按照“时长:开通所需积分”格式填写，每行一个，时长以天为单位，免费测评此设置无效。</span>
							</div>
						</div>
						<div class="form-group">
							<label for="basicprice" class="control-label col-sm-2">测评简介</label>
							<div class="col-sm-9">
