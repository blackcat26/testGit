						...
						<fieldset>
					        <table class="table table-hover table-bordered">
					            ...
					            <tbody>
							        ...
							        <tr>
										<td><input {x2;if:v:question['qruserid'] != $_user['userid']}disabled{x2;endif}  type="checkbox" name="delids[{x2;v:question['qrid']}]" value="1"></td>
										<td>
											{x2;v:question['qrid']}
										</td>
										<td>
										...
										<td>
											<div class="btn-group">
												...
												<!--判断是否是同一个用户-->
												{x2;if:v:question['qruserid'] == $_user['userid']}
