							...
							<tr>
								...
								<td>
									<div class="btn-group">
										...
										<a class="btn" href="index.php?exam-master-basic-section&subjectid=<?php echo $subject['subjectid']; ?>&page=1&basicid=<?php echo $basic['basicid']; ?><?php echo $this->tpl_var['u']; ?>" title="知识点列表"><em class="glyphicon glyphicon-th-list"></em></a>
