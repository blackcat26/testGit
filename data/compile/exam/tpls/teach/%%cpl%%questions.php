...
<?php } ?>
 ...
 $qid++; ?>
							        <tr>
										<td>
											<input <?php if($question['questionuserid'] != $this->tpl_var['_user']['userid']){ ?>disabled<?php } ?> type="checkbox" name="delids[<?php echo $question['questionid']; ?>]" value="1">
										</td>
										<td>
										...
										<td>
											<div class="btn-group">
												...
												<!--判断是否是同一个用户-->
												<?php if($question['questionuserid'] == $this->tpl_var['_user']['userid']){ ?>
