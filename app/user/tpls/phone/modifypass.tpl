		...
		<form action="index.php?user-phone-privatement-modifypass" method="post" class="form-horizontal" style="padding:20px;">
			<fieldset>
				<div class="form-group">
					...
					<div class="col-sm-10"><input id="oldpassowrd" type="password" class="form-control input-lg" value="" name="oldpassword" needle="needle" datatype="password" msg="密码字数必须在6位以上"/></div>
				</div>
				<div class="form-group">
					<label class="control-label col-sm-2">新密码：</label>
					<div class="col-sm-10"><input id="modpassword1" type="password" class="form-control input-lg" value="" name="args[password]" needle="needle" datatype="password" msg="密码字数必须在6位以上"/></div>
				</div>
				<div class="form-group">
					<label class="control-label col-sm-2">重复密码：</label>
					<div class="col-sm-10"><input id="modpassword2" type="password" class="form-control input-lg" value="" name="args[password2]" needle="needle" equ="modpassword1" msg="前后两次密码必须一致且不能为空"/></div>
				</div>
				<div class="form-group">
