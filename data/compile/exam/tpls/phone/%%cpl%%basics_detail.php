...
<?php } ?>
 ...
 $pid++; ?>
						...
						<p>
							<input value="<?php echo $this->tpl_var['basic']['basicid']; ?>" name="basicid" type="hidden"/>
							<input id="freeEstablishIpt" class="btn btn-primary btn-block" value="免费开通" type="submit"/>
						</p>
						<?php } ?>
					</form>
					<?php } else { ?>
					<p>
						<a id="gotoExamBtn" class="btn btn-primary ajax btn-block" href="index.php?exam-phone-index-setCurrentBasic&basicid=<?php echo $this->tpl_var['basic']['basicid']; ?>">进入考场</a>
					</p>
					<?php } ?>
				</div>
			</div>
