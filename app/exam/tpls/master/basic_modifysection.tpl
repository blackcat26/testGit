...
{x2;endif}
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						添加知识点
						<a class="btn btn-primary pull-right" href="index.php?exam-master-basic-section&subjectid={x2;$subjectid}&page={x2;$page}">知识点管理</a>
					</h4>
		        	<form action="index.php?exam-master-basic-modifysection" method="post" class="form-horizontal">
		    			...
		    			<div class="form-group">
							...
							<div class="col-sm-4">
								<input class="form-control" name="args[section]" id="section" type="text" size="30" value="{x2;$section['section']}" class="required" alt="请输入知识点名称"/>
							</div>
						</div>
						<div class="form-group">
